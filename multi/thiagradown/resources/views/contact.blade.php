...
<html lang="en">
  <head>
    ...
    <title>THIAGRADOWN-ENTREPRISE</title>
  ...
  <body>
					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="portfolio.html">Gqlerie</a></li>
		...
		<div class="container">
			<div class="text-center">
				<div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
					<h2>Contactew  nous</h2>					
				</div>
				<div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.6s">
					<p>Pour toute question relative a notre service veillez nous contacter s'il vous plait</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="contact-info">
			<div class="col-md-5">
				<h2>C'est Thiagradown-Entreprise</h2>
				<h3>Ces inspirations sont pour nos visiteurs et nos clients</h3>
				<p>Nos contacts ci-joint</p>
				<ul>
		...
		<div class="footer">
			<div class="container">
				<div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.2s">
					<h2>Thiagradown</h2>
					<p>Notre service au coeur des preoccupations sociales et pedagogiques.</p>
