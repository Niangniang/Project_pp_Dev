				...
				<div class="container">					
					<div class="navbar-header">
						...
						<div class="navbar-brand">
							<a href="index.html"><h1><span>Thia</span>gradown</h1></a>
						</div>
					</div>
					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="portfolio.html">Galerie</a></li>
			...
			<div class="text-center">
				<div class="services-box">
					...
					<div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.6s">	
						<p>Nos services vous proposent de multitudes oportinutes</p>
					</div>
					...
					<div class="col-md-4">
						...
						<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.3s">
							<h4>Decumentation en lecture</h4>
							<p>Afin d'apporter quelques chose de concret dans la technologie et du numerique nous vous apportons une decouverte sur notre documentation</p>
						</div>
					</div>
					...
					<div class="col-md-4">
						...
						<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.9s">
							<h4>Responsive</h4>
							<p>Notre entreprise fait partis des meilleurs fournisseurs de sites responsives </p>
						</div>
					</div>
					...
					<div class="col-md-4">
						...
						<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="1.5s">
							<h4> Support gratus</h4>
							<p>Des supports de cours sont enfin disponsibles dans nos sites web afin de permettre a nos clients d'acquerir quelques connaissances.</p>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="skills">
		<div class="container">
			<div class="text-center">
				...
				<div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.6s">
					<p>Chaque annee nos chiffre d'affaires sur differents domaines varient de maniere exponentielle.Le graphe suivant indique les evolutions  
					des differents dommaines pour differents developpeurs </p>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="col-md-6 wow fadeInLeft" data-wow-offset="0" data-wow-delay="0.6s">
						<div class="media">
							...
							<div class="media-body">
								<h4 class="media-heading">Niang Mountagha</h4>
						...
						<div class="media">
							...
							<div class="media-body">
								<h4 class="media-heading">Ba Abdoulaye </h4>
								<p>Cras urna felis accumsan at ultricesid posuere masa um socisd natoque penatibus magnisd Lorem ipsum dolor sit ame onsectea dipe.</p>
							</div>
						</div>					
						...
						<div class="media">
							...
							<div class="media-body">
								<h4 class="media-heading">Idrissa </h4>
								<p>Cras urna felis accumsan at ultricesid posuere masa um socisd natoque penatibus magnisd Lorem ipsum dolor sit ame onsectea dipe.</p>
							</div>
						</div>	
					</div>
		...
		<div class="footer">
			<div class="container">
				<div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.2s">
					<h2>Thiagradown</h2>
					<p>Une entreprise de qualites et de confiances .</p>
				...
				<div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.4s">
					<h3>RECENTS POSTS</h3>
					<ul>
						<li>Faisseurs de disign</li><hr>
						<li>disigners ambauches pour le renfrcement du dommaine </li><hr>
						<li> </li><hr>
						<li></li>
					</ul>
				</div>
				...
				<div class="col-md-4 wow fadeInUp" data-wow-offset="0" data-wow-delay="0.6s">
					<h3>CONTACT INFO</h3>
					<ul>
						<li><i class="fa fa-home fa-2x"></i> Thierno niang , tel 77334 79 50 ,adresse </li><hr>
